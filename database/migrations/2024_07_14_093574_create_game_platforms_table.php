...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('game_platforms')->insert([
            ...
            ['game_id' => 4, 'platform_id' => 7],
            ['game_id' => 4, 'platform_id' => 8],
            ['game_id' => 4, 'platform_id' => 9],
            ['game_id' => 4, 'platform_id' => 10],
            ['game_id' => 4, 'platform_id' => 11],
            ['game_id' => 5, 'platform_id' => 1],
            ['game_id' => 5, 'platform_id' => 2],
            ['game_id' => 5, 'platform_id' => 4],
            ['game_id' => 5, 'platform_id' => 7],
            ['game_id' => 5, 'platform_id' => 8],
            ['game_id' => 5, 'platform_id' => 9],
            ['game_id' => 5, 'platform_id' => 10],
            ['game_id' => 5, 'platform_id' => 11],
            ['game_id' => 6, 'platform_id' => 7],
            ['game_id' => 6, 'platform_id' => 8],
            ['game_id' => 6, 'platform_id' => 9],
            ['game_id' => 6, 'platform_id' => 10],
            ['game_id' => 6, 'platform_id' => 11],
            ['game_id' => 7, 'platform_id' => 1],
            ['game_id' => 7, 'platform_id' => 2],
            ['game_id' => 8, 'platform_id' => 1],
            ['game_id' => 8, 'platform_id' => 2],
            ['game_id' => 9, 'platform_id' => 9],
        ]);
    }
